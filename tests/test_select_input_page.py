...
class TestSelectInputPage:
    def test_single_select_button(self, page):
    ...
    def test_first_multiple_selects_button(self, page):
        base = SelectInputPage(page)
        base.open_select_page()
    ...
    def test_second_multiple_selects_button(self, page):
        base = SelectInputPage(page)
        base.open_select_page()
        base.click_multiple_selects_button()
